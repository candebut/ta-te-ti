...
class App extends React.Component {
  ...
  processBoard() {
      ...
      if (firstMark != 2) {
        ...
        if (marks.length == 3) {
          document.querySelector("#message1").innerHTML =
            "¡Ganó " + String.fromCharCode(symbolsMap[marks[0]][1]) + "!";
    ...
    if (!this.state.boardState.includes(2) && !won) {
      document.querySelector("#message2").innerHTML = "Game Over - ¡Empate!";
    ...
    return (
      <div>
        <div class="container jumbotron" id="container">
          ...
          <p>Es el turno de {String.fromCharCode(symbolsMap[this.state.turn][1])}</p>
